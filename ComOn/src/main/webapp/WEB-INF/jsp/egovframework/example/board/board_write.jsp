	...
	<form id="write" action="write.do" name="write" method="post">
		<div id="sub_contents" class="board head_mg mb140">
			...
			<div class="bbs_write w_box top no_line">
				...
				<input type="text" name="title" id="" placeholder="게시물 제목 입력" class="mb10" value="${myComonVo.title}"/>
				<textarea rows="10" name="content" id="content" placeholder="게시물 내용 입력"></textarea>
				<div class="add_photo">
